var L = require("leaflet"),
  ...
  OSRMSTYCHv1 = require("./osrmstych-v1");
(Plan = require("./plan")),
...
L.routing = {
  ...
  osrmstychv1: function (options) {
    return new OSRMSTYCHv1(options);
  },
  ...
  geocoderElement: function (
    wp,
    i,
    nWps,
    plan
  ) {
    return new L.Routing.GeocoderElement(
      wp,
      i,
      nWps,
      plan
...
module.exports = L.Routing = {
  ...
  osrmstychv1: L.routing.osrmstychv1,
  geocoderElement:
    L.routing.geocoderElement,
  mapbox: L.routing.mapbox,
  stych: L.routing.stych,
