//  SPDX-FileCopyrightText: 2023 The DefinitelyTyped contributors
//  SPDX-License-Identifier: MIT
import * as L from 'leaflet';

// API of leaflet-routing-machine
declare module 'leaflet' {
  namespace Routing {
    ...
    interface PlanOptions {
      ...
      geocoderPlaceholder?:
        | ((waypointIndex: number, numberOfWaypoints: number) => string)
        | undefined;
      ...
      createGeocoder?:
        | ((waypointIndex: number, numberOfWaypoints: number, plan: Plan) => {})
        | undefined;
    ...
    interface GeocoderElementOptions {
      createGeocoder?:
        | ((i: number, nWps: number, options: GeocoderElementOptions) => any)
        | undefined;
      geocoderPlaceholder?:
    ...
    interface IRoute {
      ...
      inputWaypoints?: Waypoint[] | undefined;
