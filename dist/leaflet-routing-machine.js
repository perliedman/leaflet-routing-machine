...
},{"./geocoder-control":6,"./itinerary":10,"./line":11,"./osrm":13,"./plan":14,"./waypoint":15}],5:[function(require,module,exports){
(function (global){
'use strict';
...
module.exports = L.Class.extend({
	...
	formatInstruction: function(instr, i) {
		if (instr.text === undefined) {
			return L.Util.template(this._getInstructionTemplate(instr, i),
				L.extend({
					exitStr: instr.exit ? Localization[this.options.language].formatOrder(instr.exit) : '',
					dir: Localization[this.options.language].directions[instr.direction]
				},
				instr));
		} else {
			return instr.text;
	...
	_getInstructionTemplate: function(instr, i) {
		var type = instr.type === 'Straight' ? (i === 0 ? 'Head' : 'Continue') : instr.type,
			strings = Localization[this.options.language].instructions[type];
...
},{"./localization":12}],6:[function(require,module,exports){
(function (global){
var L = (typeof window !== "undefined" ? window.L : typeof global !== "undefined" ? global.L : null),
...
},{"./geocoder-element":7,"./waypoint":15}],7:[function(require,module,exports){
(function (global){
'use strict';
...
module.exports = L.Class.extend({
	...
	options: {
		...
		geocoderPlaceholder: function(i, numberWaypoints, plan) {
			var l = Localization[plan.options.language].ui;
			return i === 0 ?
				l.startPlaceholder :
				(i < numberWaypoints - 1 ?
...
},{"./autocomplete":3,"./localization":12}],8:[function(require,module,exports){
(function (global){
var L = (typeof window !== "undefined" ? window.L : typeof global !== "undefined" ? global.L : null),
...
},{"./autocomplete":3,"./control":4,"./formatter":5,"./geocoder-element":7,"./itinerary":10,"./line":11,"./localization":12,"./osrm":13,"./plan":14,"./waypoint":15}],9:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./formatter":5,"./instruction-element":9}],11:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./waypoint":15,"corslite":1,"polyline":2}],14:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./geocoder-element":7,"./waypoint":15}],15:[function(require,module,exports){
(function (global){
'use strict';
