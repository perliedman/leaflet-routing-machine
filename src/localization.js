      ...
      for (var i = 0, l = this._langs.length; i < l; i++) {
        ...
        if (!Localization[this._langs[i]]) {
          if (Localization[generalizedCode]) {
            ...
            throw new Error(
              'No localization for language "' + this._langs[i] + '".'
            );
          }
        }
      }
  ...
  module.exports = L.extend(Localization, {
    ...
    ca: {
      ...
      instructions: {
        ...
        EndOfRoad: [
          "Gira {modifier} al final de la carretera",
          " cap a {road}",
        ],
        Onto: "cap a {road}",
      },
    ...
    id: {
      ...
      instructions: {
        // instruction, postfix if the road is named
        Head: ["Menuju {dir}", " di {road}"],
        Continue: ["Lanjut {dir}"],
        TurnAround: ["Berputar"],
        WaypointReached: ["Waypoint tercapai"],
        Roundabout: ["Ambil jalan keluar {exitStr} bundaran", " ke {road}"],
        DestinationReached: ["Sampai tujuan"],
